...
export function Methodology({ lang }: { lang: Lang }) {
  ...
  const ownmodel = (
    <>
      <h3>{en ? 'Our own trainable depth+pose model' : 'Nuestro modelo entrenable de profundidad+pose'}</h3>
      <p>{en
